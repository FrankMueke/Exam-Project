                    ...
                    <div class="collapse navbar-collapse float-md-right" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link">Home</span><span class="sr-only">(current)</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="students.php">Student Portal</a>
                            </li>    
                            <li class="nav-item">
                                <a class="nav-link" href="lecturers.php">Lecturers Portal</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="cod.php">COD Portal</a>
                            </li>
